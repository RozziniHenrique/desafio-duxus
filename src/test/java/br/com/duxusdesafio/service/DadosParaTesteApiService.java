...
public class DadosParaTesteApiService {
  ...
  public void inicializa() {
    ...
    // integrantes
    // nba
    michael_jordan = new Integrante(
      "Michael Jordan",
      "ala",
      composicaoTime1994E1995
    );
    michael_jordan.setId(1L);
    denis_rodman = new Integrante(
      "Denis Rodman",
      "ala-pivô",
      composicaoTime1995
    );
    denis_rodman.setId(2L);
    scottie_pippen = new Integrante(
      "Scottie Pippen",
      "ala",
      composicaoTime1995
    );
    ...
    timeChicagoBullsDe1994 = new Time(
      clubeChicagoBulls,
      data1994,
      composicaoTime1994
    );
    timeChicagoBullsDe1994.setId(1l);
    timeChicagoBullsDe1995 = new Time(
      clubeChicagoBulls,
      data1995,
      composicaoTime1995
    );
    timeChicagoBullsDe1995.setId(2l);
    timeDetroitPistonsDe1993 = new Time(
      clubeDetroitPistons,
      data1993,
      composicaoTime1993
    );
    ...
    composicaoTime1994.add(
      new ComposicaoTime(1L, timeChicagoBullsDe1994, michael_jordan)
    );
    composicaoTime1994.add(
      new ComposicaoTime(2L, timeChicagoBullsDe1994, denis_rodman)
    );
    composicaoTime1994.add(
      new ComposicaoTime(3L, timeChicagoBullsDe1994, scottie_pippen)
    );

    composicaoTime1995.add(
      new ComposicaoTime(4L, timeChicagoBullsDe1995, michael_jordan)
    );
    composicaoTime1995.add(
      new ComposicaoTime(5L, timeChicagoBullsDe1995, denis_rodman)
    );
    composicaoTime1995.add(
      new ComposicaoTime(6L, timeChicagoBullsDe1995, scottie_pippen)
    );

    // composição detroid pistons
    composicaoTime1993.add(
      new ComposicaoTime(7L, timeDetroitPistonsDe1993, denis_rodman)
    );
